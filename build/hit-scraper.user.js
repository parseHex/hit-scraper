...
var HITStorage$1 = new HITStorage();
...
function meld (reviews) {
	...
	Array.from(table.querySelectorAll('.db')).forEach(el => HITStorage$1.test(el));
...
class DBQuery {
	constructor(node) {
		...
		HITStorage$1.query(node).then(r => {
